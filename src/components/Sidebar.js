    ...
    return (<>
        ...
        <Grid container mb={1} style={{ backgroundColor: "#F7F8F9", height: "100%" }}>
            <Grid container md={2} lg={2} ml={2} mt={4} sx={{ display: { xs: 'none', sm:'none', md:'block', lg: 'block' } }}>
                ...
                <Button onClick={() => {navigate("/")}}><Grid md={12} lg={12} style={{ display: 'flex', alignItems: 'center' }} mb={3}><WorkspacePremiumOutlinedIcon sx={{color:"#1E232C"}}/><Typography><Box sx={{ ml: 2,fontWeight:'bold',fontFamily:"Urbanist",fontSize:'15px',color:"#1E232C",textTransform:"none"  }}>Subscriptions</Box></Typography></Grid></Button>
