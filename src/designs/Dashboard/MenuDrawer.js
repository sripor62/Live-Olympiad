                    ...
                    <Grid container mb={1} style={{ height: "100%" }}>
                        <Grid item>
                            <Grid container md={2} lg={2} ml={2} mt={4} sx={{ display: { xs: 'block', sm: 'block', md: 'none', lg: 'none' } }}>
                                <Grid onClick={() => {navigate("/dashboard")}} item xs={12} sm={12} md={12} lg={12} style={{ display: 'flex', alignItems: 'center',color: (page === 0) ? "#FCBD42": "#1E232C" }} mb={3}>{(page === 0) ? <img alt="" src='../images/space_dashboard.png' />: <img alt="" src='../images/space_dashboardblack.png'/>}
                                    <Box>
                                        <Box sx={{ ml: 2,fontWeight: 'bold', fontFamily: "Urbanist", fontSize: '15px', color:  (page === 0) ? "#FCBD42": "#1E232C", textTransform: "none" }}>Dashboard </Box>
                                    </Box>
                                </Grid>
                                <Grid onClick={() => {navigate("/profile")}} item xs={12} sm={12} md={12} lg={12} style={{ display: 'flex', alignItems: 'center',color:(page === 1) ? "#FCBD42": "#1E232C" }} mb={3}><AccountCircleOutlinedIcon />
                                    <Box>
