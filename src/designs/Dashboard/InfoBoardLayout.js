                ...
                <Grid item xs={12}>
                    <Grid container alignItems="center">
                        <Grid item>
                            ...
                            <Typography variant='body1' sx={{ fontFamily: 'Urbanist' }}><FiberManualRecord sx={{ fontSize: '8px' }} /> 1. Practice test in each subject will stay available for all participants on January 21, 2023 from 8am till 11:59pm. Students can attempt the mock tests in any subject sequence</Typography>
                            <Typography variant='body1' sx={{ fontFamily: 'Urbanist' }}><FiberManualRecord sx={{ fontSize: '8px' }} /> 2. Purpose of practice test is to replicate the real-Olympiad test session and help a child get complete familiarity with the test and proctoring environment</Typography>
