...
export const MobileVerificationLayout = (props) => {
    return <Grid container mt={6} justifyContent="center" alignItems="center">
        <Grid xs={6} lg={12} >
            <Typography variant='h2' fontSize="40px" fontWeight="bold"><Box mb={1}  width="190px" sx={props.responsiveStype.Mobilever.Typo} >Mobile Verification</Box></Typography>
        </Grid>
        <Grid xs={12}>
        ...
        <Grid xs={12}  sx={{justifyContent: { xs: 'center', lg: 'left' },alignItems: { xs: 'center', lg: 'left' }}}>
            <Box mb={2} width={1}>
        ...
        <Grid xs={12}>
            <Typography variant='body2'  fontWeight='medium'><Box mb={3} mt={18} sx={props.responsiveStype.Mobilever.Typo}>OTP Not Recieved? <Link href="#" style={{textDecoration:"none" ,fontWeight:"bold"}} fontWeight="bold">Resend</Link></Box></Typography>
        </Grid>
        {
