			...
			<Grid container>
				<Grid item xs={12}>
					...
					>
						<Box
							...
							mt={6}
							fontWeight="bold"
							sx={props.responsiveStype.Signup.Typo}
						>
							Sign Up
						</Box>
					</Typography>
				...
				<Grid item xs={12}>
					<Typography
						...
						fontWeight={600}
					>
						<Box mb={3} sx={props.responsiveStype.Signup.Typo}>
							Existing User? Enter your phone number below.
						</Box>
					</Typography>
				</Grid>
				<Grid item xs={12}>
					<Box mb={2} width={1}>
						<CustomTextField
							...
							error={
								props.submitFlag &&
								props.getErrorMsz("phone_number", props.pageData.phoneNumber) !=
									""
							}
							errorMsz={props.getErrorMsz(
								"phone_number",
								props.pageData.phoneNumber
							)}
							inputProps={{
								sx: {
									color: "#838BA1",
