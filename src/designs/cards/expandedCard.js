...
const GoldCard= () => {
    ...
    return (
      <HomeLayout>        
       <Box sx={{ flexGrow: 0.5, marginLeft: { xs: 0, sm: '10px' }, width: { xs: '100%', sm: 'auto' },height: { xs: '100%', sm: 'auto' } }}>
        <Grid container spacing={1} minHeight={{ xs: 160, sm: 240 }}>
          ...
          <div className='ExpandedCard'
            ...
            >
              <Box sx={{ flexGrow: 1, marginLeft: { xs: 0, sm: '10px' }, width: { xs: '100%', sm: 'auto' },height: { xs: '100%', sm: 'auto' } }}>
